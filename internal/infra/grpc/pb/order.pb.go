...
func (x *FindAllOrderRequest) GetPage() string {
	if x != nil {
		return x.Page
	}
	return ""
...
func (x *FindAllOrderRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *FindAllOrderRequest) GetSort() string {
	if x != nil {
		return x.Sort
	}
	return ""
...
func (x *FindAllOrderResponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *FindAllOrderResponse) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *FindAllOrderResponse) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *FindAllOrderResponse) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
type FindAllOrdersResponse struct {
	...
	Orders []*FindAllOrderResponse `protobuf:"bytes,1,rep,name=orders,proto3" json:"orders,omitempty"` // Resposta para múltiplos pedidos
}
...
func (x *FindAllOrdersResponse) GetOrders() []*FindAllOrderResponse {
	if x != nil {
		return x.Orders
	}
	return nil
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0x53,
	0x0a, 0x13, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65,
	...
	0x6f, 0x72, 0x74, 0x22, 0x6f, 0x0a, 0x14, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x4f, 0x72,
	...
	0x72, 0x69, 0x63, 0x65, 0x22, 0x49, 0x0a, 0x15, 0x46, 0x69, 0x6e, 0x64, 0x41, 0x6c, 0x6c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a,
	...
	0x12, 0x40, 0x0a, 0x0a, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x17,
	...
	0x64, 0x41, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	3, // 0: pb.FindAllOrdersResponse.orders:type_name -> pb.FindAllOrderResponse
	0, // 1: pb.OrderService.CreateOrder:input_type -> pb.CreateOrderRequest
	2, // 2: pb.OrderService.ListOrders:input_type -> pb.FindAllOrderRequest
	1, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
	4, // 4: pb.OrderService.ListOrders:output_type -> pb.FindAllOrdersResponse
